...
def predict_note_authentication(SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, PCR, AST, ALT, ALP, GGT, LDH):
    ...
    prediction=classifier.predict([[SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, PCR, AST, ALT, ALP, GGT, LDH]])
    print(prediction)
    return prediction
...
def main():
    ...
    Linfociti = st.text_input("Linfociti","Type Here")
    ...
    PCR = st.text_input("PCR","Type Here")
    ...
    if st.button("Predict"):
        result=predict_note_authentication(SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, PCR, AST, ALT, ALP, GGT, LDH)
