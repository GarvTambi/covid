...
def predict_note_authentication(SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, AST, ALT, ALP, GGT, LDH):
    ...
    prediction=classifier.predict([[SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, AST, ALT, ALP, GGT, LDH]])
    print(prediction)
    return prediction
...
def main():
    ...
    if st.button("Predict"):
        result=predict_note_authentication(SESSO, AGE, WBC, Piastrine, Neutrofili, Linfociti, Monociti, Eosinofili, Basofili, AST, ALT, ALP, GGT, LDH)
